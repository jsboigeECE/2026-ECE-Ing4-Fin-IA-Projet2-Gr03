"""
Modèle LightGBM pour le Credit Scoring XAI.
"""
...
from src.config import RANDOM_STATE, MODELS_DIR, LIGHTGBM_PARAMS
...
class LightGBMModel:
    """
    Modèle LightGBM pour le scoring de crédit.
    """
    ...
    def __init__(
        ...
        Args:
            params: Paramètres du modèle LightGBM
    ...
    def get_feature_importance(self, importance_type: str = 'split') -> pd.DataFrame:
        ...
        Args:
            importance_type: Type d'importance ('split' ou 'gain')
...
if __name__ == "__main__":
    # Test du module
    print("Test du module LightGBMModel...")
    ...
    model.save(str(MODELS_DIR / "lightgbm_model.pkl"))